...
class NPPrint(NPPages):
    ...
    def __init__(self, master: Tk, commands: list[Any, Any] = None):
        ...
        # self._data.initText(mode = "content", text = currentLanguage["print"]["data"]["text1"], wrap = True)
        ...
        self._interact.initText(mode = "heading", text = currentLanguage["print"]["interact"]["text0"], justify = "left")
        self._interact.initText(mode = "content", text = currentLanguage["print"]["interact"]["text1"], justify = "left")
        self._interact.initText(mode = "content", text = "", justify = "center")
        self._interact.initText(mode = "heading", text = currentLanguage["print"]["interact"]["text2"], justify = "left")
        self._interact.initText(mode = "content", text = currentLanguage["print"]["interact"]["text3"], justify = "left")
