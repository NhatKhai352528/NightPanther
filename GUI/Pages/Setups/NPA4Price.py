...
class NPA4Price(NPPages):
    ...
    def __init__(self, master: Tk, commands: list[Any, Any] = None):
        ...
        self._data.initText(mode = "title", text = currentLanguage["a4Price"]["data"]["title"], wrap = True)
        self._data.initText(mode = "Content", text = currentLanguage["a4Price"]["data"]["text0"], wrap = True)
        
        # Initialize items for control frame
        self._control.initButton(position = "left", command = self._commands[0], state = "normal", text = currentLanguage["a4Price"]["control"]["left"])
        self._control.initButton(position = "right", command = self._commands[1], state = "normal", text = currentLanguage["a4Price"]["control"]["right"])
        
        # Initialize items for interact frame
        self._interact.initText(mode = "content", text = "", justify = "center")
        self._interact.initText(mode = "heading", text = currentLanguage["a4Price"]["interact"]["text0"], justify = "center")
        
        self._interact.initText(mode = "content", text = "", justify = "center")
        self._interact.initText(mode = "content", text = currentLanguage["a4Price"]["interact"]["text1"], justify = "center")
        ...
        self._interact.initText(mode = "content", text = "", justify = "center")
        self._interact.initText(mode = "content", text = currentLanguage["a4Price"]["interact"]["text2"], justify = "center")
