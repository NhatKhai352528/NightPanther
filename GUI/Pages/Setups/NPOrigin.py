...
class NPOrigin(NPPages):
    ...
    def __init__(self, master: Tk, commands: list[Any, Any] = None, switchCommands: list[Any] = None):
        ...
        self._interact.initText(mode = "heading", text = currentLanguage["origin"]["interact"]["text0"], justify = "center")
        
        self._interact.initText(mode = "content", text = "", justify = "center")
        self._firstSwitchIndex = self._interact.initButton(command = self._switchCommands[0], text = currentLanguage["origin"]["interact"]["text1"])
        
        self._interact.initText(mode = "content", text = "", justify = "center")
        self._secondSwitchIndex = self._interact.initButton(command = self._switchCommands[1], text = currentLanguage["origin"]["interact"]["text2"])
