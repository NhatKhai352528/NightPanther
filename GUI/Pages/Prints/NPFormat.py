...
class NPFormat(NPPages):
    ...
    def __init__(self, master: Tk, commands: list[Any, Any] = None, fileName: str = None, availablePaper: list[bool] = None, availableSides: list[bool] = None):
        ...
        # self._control.initButton(position = "left", command = self._commands[0], state = "normal", text = self._currentLanguage["format"]["control"]["left"])
        ...
        self._interact.initText(mode = "heading", text = self._currentLanguage["format"]["interact"]["text1"], justify = "center")
