...
class NPAdmin(NPPages):
    ...
    def __init__(self, master: Tk, commands: list[Any, Any] = None, switchCommands: list[Any] = None):
        ...
        self._interact.initText(mode = "content", text = "", justify = "center")
        self._firstSwitchIndex = self._interact.initButton(command = self._switchCommands[0], text = "Hien thi trang thai")#self._currentLanguage["helpInitial"]["interact"]["text1"])
        ...
        self._interact.initText(mode = "content", text = "", justify = "center")
        self._secondSwitchIndex = self._interact.initButton(command = self._switchCommands[1], text = "Tat")#self._currentLanguage["helpInitial"]["interact"]["text1"])
